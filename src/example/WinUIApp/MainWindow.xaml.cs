...
public sealed partial class MainWindow : Window
{
    ...
    private void NewDoc_Click(object _, RoutedEventArgs __)
    {
        Document doc = new Document();

        CreateNewDocumentEventArgs e = new CreateNewDocumentEventArgs("Title", doc);
        object obj = new object();

        DockManager_CreateNewDocument(obj, e);
